<form method="POST" action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data"
    ...
    <! Select Category -->
        ...
        <div class="space-y-3">
            ...
            <div class="relative group">
                <input id="published_at"
                    ...
                    value="{{ old('published_at', $post->published_at?->format('Y-m-d\TH:i')) }}" autofocus />
        ...
        <div class="space-y-2">
            ...
            <x-file-input id="image" class="block w-full mt-1" type="file" name="image" :value="old('image', $oldImage)" />
